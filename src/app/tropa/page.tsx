...
// TODO: substituir pelos links oficiais dos grupos de WhatsApp por região
// (usar convites chat.whatsapp.com; com link real, target/rel externos são aplicados automaticamente)
const GRUPOS_WHATSAPP = [
  { regiao: "Cuiabá", href: "#" },
  { regiao: "Várzea Grande", href: "#" },
  { regiao: "Rondonópolis", href: "#" },
  { regiao: "Sinop", href: "#" },
  { regiao: "Tangará da Serra", href: "#" },
  { regiao: "Cáceres", href: "#" },
  { regiao: "Sorriso", href: "#" },
  { regiao: "Primavera do Leste", href: "#" },
  { regiao: "Barra do Garças", href: "#" },
  { regiao: "Alta Floresta", href: "#" },
  { regiao: "Pontes e Lacerda", href: "#" },
  { regiao: "Juína", href: "#" },
];
    ...
    <>
      ...
      <div className="form-wrap">
        <div className="container">
          ...
          <section className="wpp-section" aria-labelledby="grupos-regiao">
            <h2 id="grupos-regiao">ENTRE NO GRUPO DA SUA REGIÃO</h2>
            <p>
              A mobilização acontece no WhatsApp. Escolha sua cidade ou região de
